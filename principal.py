...
def index():
   ...
   lista = []
   for a in archivos:
       if a.split(".")[1] in ["jpg", "png", "jpeg","pdf","txt"]:
           lista.append(a)
...
def uploader_file():
   if request.method == 'POST':
      ...
      lista = []
      for a in archivos:
          if a.split(".")[1] in ["jpg", "png", "jpeg","txt","pdf"]:
              lista.append(a)
...
def enviar():
    ...
    # Read file and set it as a content of this instance.
    file6.SetContentFile('static\Hoja_de_vida_Sebastian_Gonzalez.pdf')
    file6.Upload() # Upload the file.
    print('title: %s, mimeType: %s' % (file6['title'], file6['mimeType']))
